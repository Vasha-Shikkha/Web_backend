...
const insertPictureToWord = async (req, res) => {
    ...
    await pictureToWordModel
        .bulkCreate(entries, {
            fields: ["subTask_id", "question", "image", "options", "answer", "explanation"],
        })
        .then((r) => {
            if (r !== undefined)
...
module.exports = insertPictureToWord;
