...
const insertCaptionMatching = async (req, res) => {
	...
	await captionMatchingModel
		.bulkCreate(entries, {
			fields: ["subTask_id", "image", "caption", "explanation"],
		})
		.then((r) => {
			if (r !== undefined)
...
module.exports = insertCaptionMatching;
